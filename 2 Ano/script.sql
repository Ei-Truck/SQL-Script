    ...
    DROP IF exists view vw_visao_basica_viagem_motorista_info;

    CREATE OR REPLACE VIEW vw_visao_basica_viagem_motorista_info (
        id_viagem,
        id_motorista,
        id_segmento,
        segmento,
    ...
    CREATE OR REPLACE VIEW vw_qntd_infracoes_viagem_motorista(
        id_motorista,
        id_viagem,
        quantidade_infracao
    ) AS
