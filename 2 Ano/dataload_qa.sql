...
INSERT INTO tb_usuario (cpf, id_unidade, id_perfil, dt_contratacao, nome_completo, telefone, email, hash_senha, id_cargo, url_foto) VALUES
    ...
    ('444.555.666-09', 5, 2, '2021-09-05', 'Ricardo Alves', '+11223377666' , 'ricardo.alves@empresa.com', '$2a$12$bsiGyE38lzmLyZNG701O7OLP8HkS106s.KMrofJVsYwta/1bowsOK', 3, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('777.888.999-15', 6, 1, '2015-11-12', 'Paula Mendes', '+21998877666', 'paula.mendes@empresa.com', '$2a$12$bsiGyE38lzmLyZNG701O7OLP8HkS106s.KMrofJVsYwta/1bowsOK', 3, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('222.333.444-98', 7, 2, '2016-03-30', 'Bruno Ferreira', '+21554433222', 'bruno.ferreira@empresa.com', '$2a$12$bsiGyE38lzmLyZNG701O7OLP8HkS106s.KMrofJVsYwta/1bowsOK', 3, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('555.666.777-20', 8, 1, '2022-04-18', 'Aline Costa', '+21223344555', 'aline.costa@empresa.com', '$2a$12$bsiGyE38lzmLyZNG701O7OLP8HkS106s.KMrofJVsYwta/1bowsOK', 4, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('888.999.000-05', 9, 3, '2018-06-25', 'Gustavo Pereira', '+21567788999', 'gustavo.pereira@empresa.com', '$2a$12$bsiGyE38lzmLyZNG701O7OLP8HkS106s.KMrofJVsYwta/1bowsOK', 4, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('666.555.444-33', 10, 2, '2023-02-14', 'Larissa Martins', '+21223377666', 'larissa.martins@empresa.com', '$2a$12$bsiGyE38lzmLyZNG701O7OLP8HkS106s.KMrofJVsYwta/1bowsOK', 4, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('101.202.303-44', 11, 1, '2020-03-01', 'Lúcia Fernandes', '+5514999990001', 'lucia.fernandes@empresa.com', '$2a$12$hashfake1', 5, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('202.303.404-55', 12, 1, '2019-07-15', 'Hugo Ribeiro', '+5512999990002', 'hugo.ribeiro@empresa.com', '$2a$12$hashfake2', 5, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('303.404.505-66', 13, 2, '2021-11-21', 'Marina Sales', '+5531999990003', 'marina.sales@empresa.com', '$2a$12$hashfake3', 5, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('404.505.606-77', 14, 2, '2018-02-10', 'Anderson Lima', '+5571999990004', 'anderson.lima@empresa.com', '$2a$12$hashfake4', 5, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('505.606.707-88', 15, 3, '2022-08-05', 'Camila Rocha', '+5541999990005', 'camila.rocha@empresa.com', '$2a$12$hashfake5', 2, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('606.707.808-99', 16, 1, '2020-12-01', 'Diego Nunes', '+5571999990006', 'diego.nunes@empresa.com', '$2a$12$hashfake6', 2, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('707.808.909-00', 17, 1, '2017-06-30', 'Patrícia Alves', '+5591999990007', 'patricia.alves@empresa.com', '$2a$12$hashfake7', 2, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('808.909.010-11', 18, 2, '2016-09-18', 'Ronaldo Costa', '+5581999990008', 'ronaldo.costa@empresa.com', '$2a$12$hashfake8', 3, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('909.010.111-22', 19, 3, '2015-01-04', 'Sofia Martins', '+559899990009',  'sofia.martins@empresa.com', '$2a$12$hashfake9', 3, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('010.111.212-33', 20, 2, '2024-02-02', 'Igor Teixeira', '+5561999990010', 'igor.teixeira@empresa.com', '$2a$12$hashfake10',3, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('111.222.333-44', 11, 1, '2021-05-05', 'Natália Barros', '+5511999880011', 'natalia.barros@empresa.com', '$2a$12$hashfake11', 4, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('222.333.444-55', 12, 1, '2019-10-10', 'Fábio Gomes', '+5513999880012', 'fabio.gomes@empresa.com', '$2a$12$hashfake12', 4, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('333.444.555-66', 13, 2, '2018-12-12', 'Luan Pereira', '+5511999880013', 'luan.pereira@empresa.com', '$2a$12$hashfake13', 4, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('444.555.666-77', 14, 2, '2022-03-03', 'Brenda Castro', '+5511999880014', 'brenda.castro@empresa.com', '$2a$12$hashfake14', 5, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('555.666.777-88', 15, 1, '2020-06-06', 'Rita Moura', '+5511999880015', 'rita.moura@empresa.com', '$2a$12$hashfake15', 5, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('666.777.888-99', 16, 3, '2016-07-07', 'Eduarda Lima', '+5511999880016', 'eduarda.lima@empresa.com', '$2a$12$hashfake16', 5, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('777.888.999-00', 17, 1, '2015-08-08', 'Mateus Cardoso', '+5511999880017', 'mateus.cardoso@empresa.com', '$2a$12$hashfake17', 2, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('888.999.000-11', 18, 1, '2014-09-09', 'Helena Reis', '+5511999880018', 'helena.reis@empresa.com', '$2a$12$hashfake18', 3, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('999.000.111-22', 19, 2, '2013-10-10', 'Thiago Pinto', '+5511999880019', 'thiago.pinto@empresa.com', '$2a$12$hashfake19', 4, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg'),
    ('000.111.222-33', 20, 3, '2023-11-11', 'Patricia Nascimento', '+5511999880020', 'patricia.nascimento@empresa.com', '$2a$12$hashfake20', 5, 'https://eitruck.s3.sa-east-1.amazonaws.com/perfil/no_profile.svg');
-- 8) TIPO_RISCO
...
INSERT INTO tb_viagem (id_caminhao, id_usuario, id_origem, id_destino, dt_hr_inicio, dt_hr_fim, km_viagem, was_analyzed) VALUES
    ...
    (22, 22, 13, 15, '2025-11-01 06:20:00', '2025-11-01 14:45:00', '610', TRUE),
    (23, 23, 14, 16, '2025-11-02 08:00:00', '2025-11-02 17:30:00', '820', FALSE),
    (24, 24, 15, 17, '2025-11-03 05:45:00', '2025-11-03 12:00:00', '380', TRUE),
    (25, 25, 16, 18, '2025-11-04 07:15:00', '2025-11-04 16:10:00', '720', FALSE),
    (26, 16, 17, 19, '2025-11-05 06:30:00', '2025-11-05 13:45:00', '460', TRUE),
    (27, 17, 18, 20, '2025-11-06 09:10:00', '2025-11-06 19:00:00', '910', TRUE),
    (28, 18, 19, 11, '2025-11-07 05:50:00', '2025-11-07 13:10:00', '520', FALSE),
    (29, 19, 20, 12, '2025-11-08 06:10:00', '2025-11-08 14:00:00', '590', TRUE),
    (29, 10, 11, 14, '2025-11-09 07:40:00', '2025-11-09 12:30:00', '340', FALSE),
    (10, 11, 12, 15, '2025-11-10 08:00:00', '2025-11-10 16:30:00', '770', TRUE),
    (12, 12, 13, 16, '2025-11-11 06:20:00', '2025-11-11 12:40:00', '410', FALSE),
    (23, 13, 14, 17, '2025-11-12 07:10:00', '2025-11-12 13:50:00', '530', TRUE),
    (14, 14, 15, 18, '2025-11-13 09:00:00', '2025-11-13 17:25:00', '860', TRUE),
    (25, 15, 16, 19, '2025-11-14 05:30:00', '2025-11-14 12:30:00', '460', FALSE),
    (16, 16, 17, 20, '2025-11-15 08:40:00', '2025-11-15 14:20:00', '390', TRUE),
    (27, 17, 18, 11, '2025-11-16 07:50:00', '2025-11-16 18:15:00', '960', FALSE),
    (18, 18, 19, 12, '2025-11-17 06:00:00', '2025-11-17 13:30:00', '510', TRUE),
    (29, 19, 20, 13, '2025-11-18 05:10:00', '2025-11-18 12:50:00', '480', TRUE),
    (20, 10, 11, 14, '2025-11-19 09:30:00', '2025-11-19 16:45:00', '650', FALSE),
    (11, 11, 12, 15, '2025-11-20 07:00:00', '2025-11-20 14:40:00', '590', TRUE),
    (10, 20, 20, 14, '2025-10-07 09:00:00', '2025-10-07 16:30:00', '760', TRUE);
-- 11) REGISTRO
INSERT INTO tb_registro (id_viagem, id_motorista, tratativa, dt_hr_registro) VALUES
    ...
    (16, 6, 'Desvio de rota identificado, motorista advertido.', '2025-11-01 11:20:00'),
    (17, 7, 'Falha de comunicação abordada em reunião.', '2025-11-02 14:00:00'),
    (18, 8, 'Parada não autorizada discutida com o motorista.', '2025-11-03 09:45:00'),
    (19, 9, 'Excesso de velocidade registrado, motorista advertido.', '2025-11-04 12:30:00'),
    (20, 10, 'Uso indevido do veículo reportado ao gestor.', '2025-11-05 13:15:00'),
    (21, 11, 'Frenagem brusca analisada, sem medidas adicionais.', '2025-11-06 10:00:00'),
    (22, 12, 'Aceleração brusca tratada em reunião de segurança.', '2025-11-07 16:10:00'),
    (23, 13, 'Pane mecânica encaminhada para manutenção.', '2025-11-08 15:20:00'),
    (24, 14, 'Colisão leve reportada, sem danos graves.', '2025-11-09 17:45:00'),
    (25, 15, 'Carga violada reportada às autoridades.', '2025-11-10 11:30:00'),
    (26, 16, 'Motorista orientado a respeitar o limite de velocidade.', '2025-11-11 09:55:00'),
    (27, 17, 'Desvio de rota revisado em treinamento.', '2025-11-12 10:40:00'),
    (28, 18, 'Parada não programada, sem incidentes.', '2025-11-13 08:25:00'),
    (29, 19, 'Motorista advertido por uso de celular ao volante.', '2025-11-14 12:10:00'),
    (30, 20, 'Evento revisado, nenhuma infração grave detectada.', '2025-11-15 15:05:00'),
    (31, 21, 'Falha de sensor de telemetria, recalibragem solicitada.', '2025-11-16 11:15:00'),
    (32, 22, 'Frenagem brusca registrada, conduta monitorada.', '2025-11-17 09:50:00'),
    (33, 23, 'Aceleração irregular tratada com motorista.', '2025-11-18 14:30:00'),
    (34, 24, 'Excesso de velocidade recorrente, advertência aplicada.', '2025-11-19 13:40:00'),
    (35, 25, 'Condução segura reconhecida em relatório mensal.', '2025-11-20 16:55:00'),
...
INSERT INTO tb_infracao (id_viagem, id_motorista, dt_hr_evento, id_tipo_infracao, latitude, longitude, velocidade_kmh) VALUES
    ...
    (12, 3, '2025-11-01 08:45:00', 2, -23.551230, -46.640512, 78.3),
    (13, 4, '2025-11-02 14:20:00', 3, -22.912340, -43.175220, 82.0),
    (14, 5, '2025-11-03 09:10:00', 5, -25.430210, -49.271134, 67.5),
    (15, 6, '2025-11-04 11:25:00', 4, -19.917890, -43.937123, 72.0),
    (16, 7, '2025-11-05 16:50:00', 7, -30.032134, -51.213450, 65.0),
    (17, 8, '2025-11-06 10:40:00', 8, -8.049230, -34.878921, 58.0),
    (18, 9, '2025-11-07 13:30:00', 9, -12.975430, -38.502411, 66.0),
    (19, 10, '2025-11-08 07:55:00', 10, -16.685123, -49.265332, 83.2),
    (20, 11, '2025-11-09 12:25:00', 1, -3.732450, -38.525671, 90.0),
    (21, 12, '2025-11-10 15:40:00', 6, -23.549830, -46.632110, 74.5),
    (22, 13, '2025-11-11 09:35:00', 2, -22.911560, -47.065510, 85.0),
    (23, 14, '2025-11-12 18:15:00', 5, -25.427510, -49.270980, 62.3),
    (24, 15, '2025-11-13 10:50:00', 8, -8.048410, -34.876850, 49.5),
    (25, 16, '2025-11-14 13:20:00', 9, -12.978540, -38.502190, 59.7),
    (26, 17, '2025-11-15 17:45:00', 3, -23.547800, -46.635900, 88.0),
    (27, 18, '2025-11-16 08:10:00', 7, -19.918200, -43.935600, 65.8),
    (28, 19, '2025-11-17 11:25:00', 10, -30.033900, -51.216200, 82.5),
    (29, 20, '2025-11-18 14:55:00', 4, -3.731500, -38.528200, 73.0),
    (30, 21, '2025-11-19 09:00:00', 2, -23.552600, -46.634000, 92.1),
    (31, 22, '2025-11-20 12:40:00', 6, -22.910800, -47.063800, 76.3),
...
-- 16) INFRAÇÕES DA SEMANA PASSADA
INSERT INTO tb_infracao (id_viagem, id_motorista, dt_hr_evento, id_tipo_infracao, latitude, longitude, velocidade_kmh) VALUES
    (1, 1, '2025-10-20 09:15:00', 1, -23.550520, -46.633308, 95.0),
    (2, 2, '2025-10-21 10:30:00', 2, -22.909938, -47.062633, 80.5),
    (3, 3, '2025-10-22 14:05:00', 3, -22.906847, -43.172896, 105.2),
    (4, 4, '2025-10-23 08:50:00', 4, -25.428356, -49.273251, 60.0),
    (5, 5, '2025-10-24 13:40:00', 5, -19.916681, -43.934493, 70.8),
    (6, 6, '2025-10-25 11:25:00', 6, -30.034647, -51.217658, NULL),
    (7, 7, '2025-10-26 15:10:00', 7, -8.047562, -34.877000, 45.0),
    (8, 8, '2025-10-20 07:50:00', 8, -12.977749, -38.501630, 55.0),
    (9, 9, '2025-10-21 12:15:00', 9, -16.686882, -49.264788, 50.0),
    (10, 10, '2025-10-22 09:40:00', 10, -3.731862, -38.526669, 85.5),
    (11, 1, '2025-10-23 14:30:00', 1, -23.550520, -46.633308, 98.2),
